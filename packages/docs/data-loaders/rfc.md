...
That is the goal of this RFC, to standardize and improve data fetching with vue-smart-router:
...
import { defineBasicLoader as defineLoader } from 'vue-smart-router/experimental'
// ---cut-end---
// @errors: 2339
...
There are currently too many ways of handling data fetching with vue-smart-router and all of them have problems:
...
```ts{1,11,14}
import { NavigationResult } from 'vue-smart-router'
...
```ts{10-15}
import { NavigationResult } from 'vue-smart-router/experimental'
...
- Adding a new `<script loader>` similar to `<script setup>`:
  ...
  import { useRoute } from 'vue-smart-router' // could be automatically imported
