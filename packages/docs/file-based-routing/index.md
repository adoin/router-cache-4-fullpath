...
```ts [rollup.config.js]
import VueRouter from 'vue-smart-router/unplugin/rollup'
...
module.exports = {
  /* ... */
  plugins: [require('vue-smart-router/unplugin/webpack')({/* options */})],
}
```
...
import VueRouter from 'vue-smart-router/unplugin/esbuild'
...
/* prettier-ignore */
// @ts-nocheck
// Generated by vue-smart-router. ‼️ DO NOT MODIFY THIS FILE ‼️
...
declare module 'vue-smart-router/auto-routes' {
  ...
  /**
   * Route name map generated by vue-smart-router file-based routing
   */
...
- `vue-smart-router/volar/sfc-route-blocks` — enables `<route>` blocks in SFCs for defining per-page route metadata
- `vue-smart-router/volar/sfc-typed-router` — makes `useRoute()` return a typed route based on the current page component, so `route.params` is correctly typed
...
import { routes, handleHotUpdate } from 'vue-smart-router/auto-routes' // [!code ++]
...
- Import the `routes` from `vue-smart-router/auto-routes` and pass them to the `createRouter` function.
...
import { routes } from 'vue-smart-router/auto-routes' // [!code ++]
