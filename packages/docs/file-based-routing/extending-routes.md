...
You can modify and extend any page component with the `definePage()` macro. This is useful for adding meta information, or modifying the route object. It's globally available in Vue components but you can import it from `vue-smart-router` if needed.
...
```js{4-9}
import { createWebHistory, createRouter } from 'vue-smart-router'
