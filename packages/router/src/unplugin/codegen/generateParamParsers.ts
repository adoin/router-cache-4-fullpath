...
const PARAM_PARSER_MODULE = 'vue-smart-router/experimental'
 ...
 * `defineParamParserRaw` (from `vue-smart-router/experimental`). Aliased imports are
 * supported.
 *
...
export function isRawParamParserSource(
  ...
  // `vue-smart-router/experimental`. Aliased imports (`{ defineParamParserRaw as x }`)
