  ...
  codes: {
    ...
    VUE_ROUTER_R0021: {
      why:
        ...
        'This is likely a bug in vue-smart-router.',
    ...
    VUE_ROUTER_R0101: {
      why: (p: { path: string }) =>
        `The Matcher cannot resolve relative paths but received "${p.path}". Unless you directly called \`matcher.resolve("${p.path}")\`, this is probably a bug in vue-smart-router. Please open an issue at https://github.com/vuejs/router/issues/new/choose.`,
