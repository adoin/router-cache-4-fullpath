# vue-smart-router [![nmp version](https://img.shields.io/npm/v/vue-smart-router.svg)](https://npmx.dev/package/vue-smart-router) [![test](https://github.com/vuejs/router/actions/workflows/test.yml/badge.svg)](https://github.com/vuejs/router/actions/workflows/test.yml) [![codecov](https://codecov.io/gh/vuejs/router/graph/badge.svg?token=azNM3FI0d1)](https://codecov.io/gh/vuejs/router)
...
- Add it to an existing Vue Project:
  ...
  ```bash
  npm install vue-smart-router@5
  ```
...
<a href="https://www.browserstack.com">
  <img src="https://github.com/vuejs/vue-smart-router/raw/dev/assets/browserstack-logo-600x315.png" height="80" title="BrowserStack Logo" alt="BrowserStack Logo" />
</a>
